...
class __TwigTemplate_2115efe5d6195de04e9d85676555ba4572252e957ce05a80699aa7fc69fc5208 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
Bienvenue ";
        ...
        echo " sur votre compte SUPPIMMO :)<br>
c'est dans cette espace que vous allez gerer toute vos informations personelles.
<hr>
<a href=\"";
        // line 11
...
{% block title %}Mon compte - SUPPIMMO{% endblock %}

{% block content %}

<h1>Mon compte</h1>
Bienvenue {{app.user.firstname}} sur votre compte SUPPIMMO :)<br>
c'est dans cette espace que vous allez gerer toute vos informations personelles.
<hr>
<a href=\"{{path ('account_password')}}\">Modifier mon mot de passe</a>

{% endblock %}
", "account/index.html.twig", "/Applications/MAMP/htdocs/e-commerce/templates/account/index.html.twig");
    }
}
