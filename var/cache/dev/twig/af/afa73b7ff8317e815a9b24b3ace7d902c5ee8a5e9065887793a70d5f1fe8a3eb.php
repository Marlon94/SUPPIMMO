...
class __TwigTemplate_c3b22c6eb1557971f9978ecc34fedf9f74a66063c3256328bc7d5ca84cdd0290 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <input type=\"email\" value=\"";
        ...
        echo "\" name=\"email\" placeholder=\"Votre adresse Email\" id=\"inputEmail\" class=\"form-control\" required autofocus>
...
{% block title %}Se connecter - SUPPIMMO{% endblock %}
...
<form method=\"post\">
    ...
    <h1 class=\"h3 mb-3 font-weight-normal\">Merci de vous connecter</h1>
    <label for=\"inputEmail\">Votre Email</label>
    <input type=\"email\" value=\"{{ last_username }}\" name=\"email\" placeholder=\"Votre adresse Email\" id=\"inputEmail\" class=\"form-control\" required autofocus>
    <label for=\"inputPassword\">Votre mot de passe</label>
    <input type=\"password\" name=\"password\" id=\"inputPassword\" placeholder=\"Votre mot de passe\" class=\"form-control\" required>
...
{% endblock %}
", "security/login.html.twig", "/Applications/MAMP/htdocs/e-commerce/templates/security/login.html.twig");
    }
}
